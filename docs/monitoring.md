...
<!-- Synced from docs/monitoring.md in certpilot/certpilot at 9e9a56600009,
...
[gateways/vault.md](/gateways/vault). This is how the CA that actually signs
...
[discovery](/discovery) exists to close.*
...
[configuration.md](/configuration#renewal).
...
[operations.md](/operations#behind-a-reverse-proxy) — this is the single
