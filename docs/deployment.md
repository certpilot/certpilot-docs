...
signed with HMAC-SHA256 ([`pkg/webhooksig`](https://github.com/certpilot/certpilot/blob/main/pkg/webhooksig)) so the receiver
...
See [agent.md](/agent#installing-where-the-server-reads).
