...
<!-- Synced from docs/getting-started.md in the CertPilot repository by
...
| | |
|:---|:---|
| Issue from your own Vault | [gateways/vault.md](/gateways/vault) |
| Put a certificate on a server automatically | [deployment.md](/deployment) |
| Run the agent, so keys never leave the host | [agent.md](/agent) |
| Find certificates nobody told you about | [discovery.md](/discovery) |
| Put it on a wall display | [monitoring.md](/monitoring#wall-displays) |
| Run it for real | [operations.md](/operations) |

[docs/README.md](/) is the full index. When something goes wrong,
[troubleshooting.md](/troubleshooting) is organised by symptom.
