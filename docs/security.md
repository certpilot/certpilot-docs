...
<!-- Synced from docs/security.md in the CertPilot repository by
...
Report vulnerabilities per [SECURITY.md](https://github.com/certpilot/certpilot/blob/main/SECURITY.md).
...
Envelope encryption, in [`pkg/secrets`](https://github.com/certpilot/certpilot/blob/main/pkg/secrets).
...
[operations.md](/operations#rotating-the-kek).
...
[monitoring.md](/monitoring#wall-displays).
...
Ed25519 over a canonical string, in [`pkg/agentauth`](https://github.com/certpilot/certpilot/blob/main/pkg/agentauth):
...
HMAC-SHA256 ([`pkg/webhooksig`](https://github.com/certpilot/certpilot/blob/main/pkg/webhooksig)) so a receiver can verify the
...
[`pkg/revocation`](https://github.com/certpilot/certpilot/blob/main/pkg/revocation) builds a real OCSP request and verifies
